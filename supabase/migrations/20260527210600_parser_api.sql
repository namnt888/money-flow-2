...
create or replace function public.bulk_insert_parsed_txns(p_txns jsonb)
...
comment on function public.bulk_insert_parsed_txns is
  'Bulk insert parsed transactions from LLM JSON array. Called by /api/parse-txn route.';
